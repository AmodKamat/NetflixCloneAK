...
const options={
  ...
  headers: {
    ...
    Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjYTJhNmY3OGQxYmM3YzhjZTYyNjE0OGZkOWE4YWMwMSIsInN1YiI6IjY1YzM5MzY0ZTI2N2RlMDE3ZGJjOTVkYyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.ajav5mllpXVBVl4tNvDR9DXCBUHagfJpGYn5QBIgRZk'
  }
}
@Injectable({
  providedIn: 'root'
